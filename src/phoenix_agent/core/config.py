...
class AgentConfig:
    ...
    system_prompt: str = (
        ...
        "  2. Write a Python script and execute it with run_command\n"
        "  3. For large files, process in chunks — never try to read entire content into context\n"
        "  4. Report structured results in tables or summaries\n"
